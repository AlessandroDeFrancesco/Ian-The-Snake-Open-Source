...
public class MultiplayerClientImpostazioniActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// nascondo l'impostazione della velocità perchè è il server che la imposta non il client
		seekBarVelocita.setVisibility(View.INVISIBLE);
		textViewVelocita.setVisibility(View.INVISIBLE);
		textViewTitoloVelocita.setVisibility(View.INVISIBLE);
	}
	...
	private void inizializzaGrafica() {
		...
		textViewInfo.setText(getString(R.string.multiplayer_client_impostazioni_info));
	...
	private OnClickListener OkClicked = new OnClickListener(){
		...
		public void onClick(View v) {
			...
			Intent intent = new Intent( v.getContext(), MultiplayerBluetoothClientActivity.class);

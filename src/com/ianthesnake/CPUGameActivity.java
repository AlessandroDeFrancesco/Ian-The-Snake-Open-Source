...
public class CPUGameActivity extends BaseGameActivity {

	private CPUGameView mSnakeView;
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		setContentView(R.layout.sezione_gioco_cpu);
		...
		PopupManager.getInstance().creaPopup(PopupManager.POPUP_NUMERO_CPU, this, null);
		
		mSnakeView.setStatoGioco(CPUGameView.PRONTO);
	...
	private void recuperaGrafica() {
		mSnakeView = (CPUGameView) findViewById(R.id.snake);
